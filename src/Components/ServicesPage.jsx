        ...
        <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
          ...
          <div class="mb-10 md:mb-16">
            ...
            <p class="mx-auto max-w-screen-md text-center text-gray-800 md:text-lg">
              We provide SAP Project Consultancy, Web and App Development
              services and SAP Ariba Support.
            </p>
          </div>
          {/* <!-- text - end --> */}
            ...
            <Link to="/SAP">
              <div class="flex flex-col rounded-lg border p-4 md:p-6 ">
                ...
                <p class="mb-4 text-gray-800">
                  At our core, we specialize in delivering unparalleled SAP
                  consultancy services, guiding businesses through the
                  intricacies of SAP solutions with precision and expertise.
                </p>
                <img src={require("../Assets/sapproject.png")} alt="" />
              </div>
            </Link>
            {/* <!-- feature - end --> */}
            ...
            <Link to="/webdev">
              <div class="flex flex-col rounded-lg border p-4 md:p-6">
                ...
                <p class="mb-4 text-gray-800">
                  ...
                  development services. Our expert team crafts bespoke
                  solutions, blending innovation and functionality.
                </p>
                <img src={require("../Assets/webappdev.webp")} alt="" />
              </div>
            </Link>
            {/* <!-- feature - end --> */}

            {/* <!-- feature - start --> */}
            <a href={require("../Assets/SAPAriba.pdf")}>
              <div class="flex flex-col rounded-lg border p-4 md:p-6">
                <h3 class="mb-2 text-lg font-semibold md:text-xl">
                  Sap Ariba Support
                </h3>
                <p class="mb-4 text-gray-800">
                  Experience seamless SAP Ariba support tailored to meet your
                  business needs. Our dedicated team ensures the optimal
                  performance of your Ariba solutions
                </p>
                <img
                  src={require("../Assets/sapariba.jpg")}
                  alt=""
                  className="w-[450px] h-[240px]"
                />
              </div>
              {/* <!-- feature - end --> */}
            </a>
