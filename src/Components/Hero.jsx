...
const Hero = () => {
  return (
    <div>
      <section class="bg-white dark:bg-gray-900">
        <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
          ...
          <div class="hidden lg:mt-0 lg:col-span-5 lg:flex">
            <img
              src={require("../Assets/urban-851.gif")}
              alt="mockup"
      ...
      {/* --------------- */}
      <div>
        <div class="bg-blue-800 py-6 sm:py-8 lg:py-12">
          <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
            <h2 class="mb-8 text-center text-2xl font-bold text-white md:mb-12 lg:text-3xl">
              Our Latest Projects
            </h2>
            <h4 className="mb-8 text-center text-md font-bold text-white md:mb-8 lg:text-lg">
      ...
      <div class=" py-6 sm:py-8 lg:py-12">
        <div class="mx-auto max-w-screen-xl px-4 md:px-8">
          ...
          <div class="grid gap-4 md:grid-cols-2 md:gap-8">
            ...
            <div class="flex flex-col items-center gap-4 rounded-lg bg-blue-800 px-8 py-6 md:gap-6">
              <div class="max-w-md text-center text-white lg:text-lg">
                “This is a section of some simple filler text, also known as
                placeholder text.”
              </div>
