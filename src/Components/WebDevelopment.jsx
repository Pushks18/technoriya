          ...
          <div class="mx-auto max-w-screen-xl px-4 md:px-8">
            ...
            <div class="grid gap-4 sm:grid-cols-2 md:gap-6 lg:grid-cols-2 xl:grid-cols-2 xl:gap-8">
              ...
              <div class="flex flex-col items-center overflow-hidden rounded-lg border md:flex-row">
                ...
                >
                  <img
                    src={require("../Assets/webdesign.jpg")}
                    loading="lazy"
                ...
                <div class="flex flex-col gap-2 p-4 lg:p-6">
                  ...
                  <p class="text-gray-500">
                    ...
                    & Development services. Our team seamlessly blends creative
                    design and cutting-edge development to craft engaging and
                    responsive websites that leave a lasting impression.
                    Transform your digital identity with us, where innovation
                    meets functionality.
                  </p>
                </div>
              </div>
              ...
              <div class="flex flex-col items-center overflow-hidden rounded-lg border md:flex-row">
                ...
                >
                  <img
                    src={require("../Assets/mobiledesign.jpg")}
                    loading="lazy"
                ...
                <div class="flex flex-col gap-2 p-4 lg:p-6">
                  ...
                  <p class="text-gray-500">
                    Unleash the power of innovation with our Mobile App Design &
                    Development services. We specialize in creating sleek and
                    intuitive mobile applications that captivate users and
                    elevate your brand. From concept to deployment, trust us to
                    bring your app vision to life with expertise and precision.
                  </p>
                </div>
              </div>
              {/* <!-- article - end --> */}
              ...
              <div class="flex flex-col items-center overflow-hidden rounded-lg border md:flex-row">
                ...
                >
                  <img
                    src={require("../Assets/ecommercedesign.jpg")}
                    loading="lazy"
                ...
                <div class="flex flex-col gap-2 p-4 lg:p-6">
                  ...
                  <p class="text-gray-500">
                    ...
                    E-commerce Website Design services. We specialize in
                    creating visually stunning and user-friendly platforms that
                    seamlessly merge aesthetic appeal with intuitive navigation.
                    From custom shopping carts to secure payment gateways, we
                    ensure a tailored and engaging online shopping journey for
                    your customers.
                  </p>
                </div>
              </div>
              ...
              <div class="flex flex-col items-center overflow-hidden rounded-lg border md:flex-row">
                ...
                >
                  <img
                    src={require("../Assets/softwaredev.jpg")}
                    loading="lazy"
                ...
                <div class="flex flex-col gap-2 p-4 lg:p-6">
                  ...
                  <p class="text-gray-500">
                    ...
                    bespoke Software Development services. Our seasoned team of
                    developers crafts tailored solutions, addressing your unique
                    business needs. From concept to deployment, we turn ideas
                    into robust, scalable software, ensuring efficiency and
              ...
              <div class="flex flex-col items-center overflow-hidden rounded-lg border md:flex-row">
                ...
                <div class="flex flex-col gap-2 p-4 lg:p-6">
                  ...
                  <p class="text-gray-500">
                    Ignite your brand's online presence with our Digital Online
                    Marketing expertise. We leverage cutting-edge strategies to
                    enhance your visibility, engage your audience, and drive
                    results. From SEO optimization to targeted social media
                    campaigns, trust us to amplify your digital footprint and
              ...
              <div class="flex flex-col items-center overflow-hidden rounded-lg border md:flex-row">
                ...
                >
                  <img
                    src={require("../Assets/itservices.jpg")}
                    loading="lazy"
                    alt="Photo by Martin Sanchez"
                    class="absolute inset-0 h-full w-full object-cover object-center transition duration-200 group-hover:scale-110"
                  />
                ...
                <div class="flex flex-col gap-2 p-4 lg:p-6">
                  ...
                  <p class="text-gray-500">
                    Explore a spectrum of cutting-edge IT services tailored to
                    elevate your business. From cloud computing and
                    cybersecurity to IT consulting and beyond, our comprehensive
                    suite of services is designed to optimize your digital
                    infrastructure. Rely on our expertise to navigate the
                    ever-evolving IT landscape, ensuring efficiency, security,
                    and innovation across all facets of your technology
                    ecosystem.
                  </p>
                </div>
              </div>
