...
const ELearningPage = () => {
  ...
  const postData = async (e) => {
    e.preventDefault();
    const { name, email, phone, service } = user;

    if (name && email && phone && service) {
      const res = await fetch(
        "https://technoriya-909aa-default-rtdb.firebaseio.com/appointment.json",
        {
          method: "POST",
          headers: {
      ...
      if (res) {
        setUser({ name: "", email: "", phone: "", service: "" });
  ...
  return (
    <div>
      ...
      <div className="">
        ...
        >
          <h1 className="text-6xl text-white ">Online Learning</h1>
        </div>
      </div>
          ...
          >
            ...
            <div class="sm:col-span-2">
              ...
              >
                ...
                <option value="sap">SAP Project Consultancy</option>
                <option value="web">Web Development</option>
                <option value="app">App Development</option>
                <option value="ariba">SAP Ariba Support</option>
              </select>
            </div>
